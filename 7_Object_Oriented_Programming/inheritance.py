...
#
# Although they may differ in some ways (only Dog might have the method bark), they are likely to be
# similar in other (all having the attributes color and name).
#
